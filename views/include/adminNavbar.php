            ...
            <div class="navbar-header"><br /><br />
                <div class="banner">
                    <img src="image/ict_logo.png" class="img-responsive" width="200" height="135" style="position:absolute;margin-top:-20px;"><br />
                        <div style="color:#FFFFFF;margin-left:300px;margin-bottom:10px;margin-top:20px;font-size:40px;" class="fa fa-archive"> Online Archiving Documents in ICT Department <br />
                            <center>(OADS)</center> 
                        </div>
                </div>
            </div>
    ...
    <nav class="navbar navbar-default visible-xs">
        <div class="container-fluid">
            <div class="navbar-header"><br /><br />
                <div class="banner">
                    <img src="image/ict_logo.png" class="img-responsive" width="40" height="30" style="position:absolute;margin-top:-20px; margin-left: 10px">
                        <div style="color:#FFFFFF;margin-left:100px;margin-top:-10px;font-size:12px;" class="fa fa-archive"> Online Archiving Documents <br / ><center>in</center>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="" class="navbar-brand" id="navbar-brand"><i class="glyphicon glyphicon-user glyphicon-lg"></i> Admin</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right nav-pills">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cog fa-lg"> Setting</i> <span class="caret"></span></a>
                        <ul class="dropdown-menu">
